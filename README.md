...
- **Flexible Freight & Payment Methods**:
  - Palletized freight linehaul with inspection on delivery (COD / Carrier Escrow).
  - Direct wire transfer (ACH / SWIFT / VietQR).

---

## 🛠️ Tech Stack

- **Frontend**: HTML5 Semantic, CSS3 Responsive Grid, Pure Vanilla JavaScript (ES6+).
- **Serverless API**: Vercel Serverless Functions (`/api/notify.js`).
- **Database & Storage**: Supabase REST API + LocalStorage persistence.
- **Notifications**: Telegram Bot API + Resend Email API.
- **Hosting & CI/CD**: Vercel Cloud Platform.
